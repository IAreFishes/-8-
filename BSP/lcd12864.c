...
{  
    GPIO_Config(GPIOB, GPIO_Pin_12, GPIO_Mode_Out_PP);
    GPIO_Config(GPIOB, GPIO_Pin_13, GPIO_Mode_Out_PP);
    GPIO_Config(GPIOB, GPIO_Pin_14, GPIO_Mode_Out_PP);
    GPIO_Config(GPIOB, GPIO_Pin_15, GPIO_Mode_Out_PP);
    GPIO_Config(GPIOB, GPIO_Pin_5, GPIO_Mode_Out_PP);	
}
